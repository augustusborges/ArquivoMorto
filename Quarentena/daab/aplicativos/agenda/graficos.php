        ...
        <div class="container-fluid body_color">
            <div class="row" id="php">
                <?php
                    ...
                    $arr = "[";
                    for($i=1; $i<=count($valoresAgendados); $i++){
                        
                    $arr = $arr.'{'.'"label"'.':"'.$valoresAgendados[$i]['nomeColaborador'].'"'.', "data":'.  $valoresAgendados[$i]['valor'];
                    
                    if($i<count($valoresAgendados)){
                        $arr = $arr.'},';
                    }else{
                        $arr = $arr.'}';
                    }
                    ...
                    $caminho = BASE_DIR."config".DS."vendasmensais.json";
